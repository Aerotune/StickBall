...
class Introduction < Chingu::GameState
  ...
  def setup
    ...
    after(300) {
      @text = Chingu::Text.create("Welcome to ChinguRoids", :y => 60, :font => Gosu.default_font_name, :size => 45, :color => Colors::Dark_Orange, :zorder => Zorder::GUI)
      @text.x = 800/2 - @text.width/2 # center text
      after(300) {
        @text2 = Chingu::Text.create("Press ENTER to play", :y => 510, :font => Gosu.default_font_name, :size => 45, :color => Colors::Dark_Orange, :zorder => Zorder::GUI)
