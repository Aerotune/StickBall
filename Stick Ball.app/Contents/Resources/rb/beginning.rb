...
#    @t2 = Chingu::Text.create("StickBall", :y => 100, :font => Gosu.default_font_name, :size => 65, :color => Colors::White, :zorder => Zorder::GUI)
#    @t2.x = 800/2 - @t2.width/2 # center text

    after(300) {
    @t1 = Chingu::Text.create("Right Player", :y => 260, :font => Gosu.default_font_name, :size => 65, :color => Colors::White, :zorder => Zorder::GUI)
    @t1.x = 600 - @t1.width/2 # center text
    @t2 = Chingu::Text.create("Left Player", :y => 260, :font => Gosu.default_font_name, :size => 65, :color => Colors::White, :zorder => Zorder::GUI)
    @t2.x = 200 - @t2.width/2 # center text



#      @text1 = Chingu::Text.create("StickBall", :y => 60, :font => Gosu.default_font_name, :size => 65, :color => Colors::White, :zorder => Zorder::GUI)
#      @text1.x = 800/2 - @text1.width/2 # center text
    }
    after(600) {
      @t3 = Chingu::Text.create("Arrows", :y => 360, :font => Gosu.default_font_name, :size => 45, :color => Colors::White, :zorder => Zorder::GUI)
      @t3.x = 600 - @t3.width/2 # center text
#      @t4 = Chingu::Text.create("A S D W", :y => 360, :font => Gosu.default_font_name, :size => 45, :color => Colors::White, :zorder => Zorder::GUI)
#      @t4.x = 200 - @t4.width/2 # center text
    ...
    after(1200) {
      @text4 = Chingu::Text.create("Left Shift", :y => 500, :font => Gosu.default_font_name, :size => 45, :zorder => Zorder::GUI)
      @text4.x = 200 - @text4.width/2 # center text
      @text5 = Chingu::Text.create("Right Shift", :y => 500, :font => Gosu.default_font_name, :size => 45, :zorder => Zorder::GUI)
...
#    EndPlayer.destroy_all
    ...
    after(300) {
      @text = Chingu::Text.create("StickBall!!!", :y => 60, :font => Gosu.default_font_name, :size => 45, :color => Colors::White, :zorder => Zorder::GUI)
      @text.x = 800/2 - @text.width/2 # center text
      after(300) {
        @text2 = Chingu::Text.create("Press ENTER to play", :y => 510, :font => Gosu.default_font_name, :size => 45, :color => Colors::White, :zorder => Zorder::GUI)
        ...
        after(200) {
          ...
          after(200) {
            ...
            after (1400) {
              @knight.speak
                after(10) {
                @text3 = Chingu::Text.create("Hello", :y => 220, :font => Gosu.default_font_name, :size => 35, :color => Colors::White, :zorder => 300)
                @text3.x = 400 - @text3.width/2   # center text
                after (880) {
                  @text4 = Chingu::Text.create("Use the arrows to move", :y => 350, :font => Gosu.default_font_name, :size => 35, :color => Colors::White, :zorder => 300)
                  @text4.x = 400 - @text4.width/2
                  after (1390) {
                    @text5 = Chingu::Text.create("and the spacebar to shoot.", :y => 390, :font => Gosu.default_font_name, :size => 35, :color => Colors::White, :zorder => 300)
