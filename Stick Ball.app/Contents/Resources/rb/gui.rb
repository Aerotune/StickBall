...
#	  @star_half = Gosu::Image.new($window, "./media/gui/star_half.png")
    ...
    @power_ups_text = Chingu::Text.create("Power Ups: #{$power_ups1}", :y => 50, :font => Gosu.default_font_name, :size => 26, :color => Colors::White, :zorder => Zorder::GUI)
    @power_ups_text.x = 690 - @power_ups_text.width/2
#    @spell_text = Chingu::Text.create("Spell: #{$spell1}", :y => 80, :font => Gosu.default_font_name, :size => 26, :color => Colors::White, :zorder => Zorder::GUI)
...
#	  @star_half = Gosu::Image.new($window, "./media/gui/star_half.png")
    ...
    @power_ups_text = Chingu::Text.create("Power Ups: #{$power_ups2}", :y => 50, :font => Gosu.default_font_name, :size => 26, :color => Colors::White, :zorder => Zorder::GUI)
